$(document).ready(function (e) {
	...
	{	
		...
		window.open(url, "Receipt "+del_id, "toolbar=yes,scrollbars=yes,resizable=yes,top=200,left=600,width=800,height=600");
	});
	...
	$('#searchform').submit(function() {
		...
		var agent = $("#cagent").val();
		var publish = $("#cpublish").val();
		var param = ['searching',agent,publish];
...
'<a href="" class="btn btn-primary btn-xs text-primary" id="' +s[i][0]+ '" title=""> <i class="fa fas-2x fa-print"> </i> </a>'+
