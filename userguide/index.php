...
<head>
	...
	<title>Calculator Dswip - User Guide</title>
...
<body style="background-color:#f5f1f1 !important;">
<!-------------HEADER----------------->
...
<div class="col-md-12 mtop2 mobile">
    <img src="imgs/bg.png" alt="" class="img-responsive indeximg">
    <button class="cbutton mycbtn ff2" onclick="location.href='dashboard';"><span>Get Started</span></button>
</div>
