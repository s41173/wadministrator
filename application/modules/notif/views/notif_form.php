...
<form id="upload_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action; ?>" enctype="multipart/form-data">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
        <input type="text" class="form-control" name="tcust" id="ccust2" readonly style="width:80px; float:left;">
        <?php echo anchor_popup(site_url("customer/get_list/ccust2/"), '[ ... ]', $atts1); ?> &nbsp;
      </div>

      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
        
        <select name="ctype" id="ctype" class="form-control" style="min-width:150px;">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
        <input type="text" class="form-control" name="tsubject" id="tsubject" placeholder="Subject">
      </div>
    
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
         <textarea class="form-control" name="tcontent" id="tcontent" style="width:100%;" rows="5" placeholder="Notif Content"></textarea>
      </div>
