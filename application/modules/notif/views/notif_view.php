...
<script src="<?php echo base_url(); ?>js/moduljs/notif.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('notif/add_process/');?>";
	var sites_edit = "<?php echo site_url('notif/update_process/');?>";
	var sites_del  = "<?php echo site_url('notif/delete/');?>";
	var sites_get  = "<?php echo site_url('notif/update/');?>";
    var sites_primary = "<?php echo site_url('notif/publish/');?>";
    var sites_ajax  = "<?php echo site_url('notif/');?>";
...
?>
           ...
           <form id="searchform" class="form-inline">
               ...
               <div class="form-group">
                 <input type="text" class="form-control" name="tcust" id="ccust_search" readonly style="width:80px; float:left;">
                 <?php echo anchor_popup(site_url("customer/get_list/ccust_search/"), '[ ... ]', $atts1); ?> &nbsp;
              </div>    
...
<!--               <a class="btn btn-primary" href="<?php //echo site_url('product/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New </a>-->
      ...
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 ...
		 <?php $this->load->view('notif_update'); ?> 
      </div>
      <!-- Modal Attribute -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('notif_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
