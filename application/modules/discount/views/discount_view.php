...
<script src="<?php echo base_url(); ?>js/moduljs/discount.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('discount/add_process/');?>";
	var sites_edit = "<?php echo site_url('discount/update_process/');?>";
	var sites_del  = "<?php echo site_url('discount/delete/');?>";
	var sites_get  = "<?php echo site_url('discount/update/');?>";
    var sites_primary  = "<?php echo site_url('discount/publish/');?>";
          ...
          <div class="row"> 
           ...
           <form id="searchform" class="form-inline">
              <div class="form-group">
                ...
                <input type="text" title="Date" class="form-control" id="ds1" name="tdates" style="width:150px;">
              </div>
              ...
              <div class="form-group">
                 ...
                 <select name="cstts" id="cstts" class="select2_single form-control" style="width:150px;">
...
<form class="form-inline" id="cekallform" method="post" action="<?php echo ! empty($form_action_del) ? $form_action_del : ''; ?>">
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('discount_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Attribute -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <?php $this->load->view('discount_update'); ?> 
      </div>
      <!-- Modal Attribute -->
