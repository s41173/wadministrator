...
<script src="<?php echo base_url(); ?>js/moduljs/review.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('review/add_process/');?>";
	var sites_edit = "<?php echo site_url('review/update_process/');?>";
	var sites_del  = "<?php echo site_url('review/delete/');?>";
	var sites_get  = "<?php echo site_url('review/update/');?>";
	var sites_primary  = "<?php echo site_url('review/publish/');?>";
