...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:0px dotted #000000; ">
		...
		<table id="input" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> IC </th> <th> Name </th> <th> Phone </th> <th> Email </th> <th> Company </th> <th> Joined </th> <th> Publish </th> 
		   </tr>
           </thead>
     ...
     <a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('courier'); ?>"> 
