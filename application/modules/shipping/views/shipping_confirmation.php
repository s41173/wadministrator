...
<form id="edit_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action_confirmation; ?>" 
  ...
  <input id="dtime1" class="form-control col-md-7 col-xs-12" type="text" name="tcdates" required>
    ...
    <div class="form-group">
      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> Airway Bill </label>
      <div class="col-md-5 col-sm-12 col-xs-12">
  <input id="tairway" class="form-control col-md-7 col-xs-12" type="text" name="tairway" required>
      </div> 
    </div>
      
      <div class="form-group">
      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> Shipping Status </label>
