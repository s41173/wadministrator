...
<form id="edit_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action_update; ?>" 
      enctype="multipart/form-data">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control" id="ttitle_update" name="ttitle" required placeholder="Title">
                    <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span> 
                  </div>
                  
                  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                  	<?php $js = "class='select2_single form-control' id='cposition_update' tabindex='-1' style='width:100%;' "; 
			        echo form_dropdown('cposition', $position, isset($default['position']) ? $default['position'] : '', $js); ?>	
                    <span class="fa fa-key form-control-feedback right" aria-hidden="true"></span> 					
                  </div>
                  
                  <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control" id="torder_update" name="tmenuorder" required placeholder="Order">
                    <span class="fa fa-key form-control-feedback right" aria-hidden="true"></span> 
                  </div>
                  
                  <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
                    <input type="text" class="form-control" id="tlimit_update" name="tlimit" required placeholder="Limit">
                    <span class="fa fa-key form-control-feedback right" aria-hidden="true"></span> 
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
	                        TRUE <input name="rpublish" class="required" id="rpublish1" type="radio" value="1" /> 
							FALSE <input name="rpublish" class="required" id="rpublish0" type="radio" value="0" />  
                    </div>
                  </div>
	         ...
	         echo form_dropdown('cmenu[]', $menu, $array, $js); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                  <?php $js = "class='select2_single form-control' id='cmore_update' tabindex='-1' style='width:100%;' "; 
