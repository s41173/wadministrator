...
<script src="<?php echo base_url(); ?>js/moduljs/widget.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('widget/add_process/');?>";
	var sites_edit = "<?php echo site_url('widget/update_process/');?>";
	var sites_del  = "<?php echo site_url('widget/delete/');?>";
	var sites_get  = "<?php echo site_url('widget/update/');?>";
   ...
   <button type="button" onClick="resets();" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('widget_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('widget_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
