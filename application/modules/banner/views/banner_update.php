 ...
 action="<?php echo $form_action_update; ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tname_update" class="form-control col-md-7 col-xs-12" type="text" name="tname" required placeholder="Banner Name">
      </div>
    </div>
      ...
      <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <?php $js = "class='form-control' id='cposition_update' tabindex='-1' style='width:100%;' "; 
      ...
      <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="turl_update" class="form-control col-md-7 col-xs-12" type="text" name="turl" required placeholder="Banner Url">
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <input id="twidth_update" class="form-control col-md-1 col-xs-1" type="number" name="twidth" required placeholder="Width">
            <input id="theight_update" class="form-control col-md-1 col-xs-1" type="number" name="theight" required placeholder="Height">
          </div>
      </div>
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <img id="catimg_update" style=" max-width:150px; height:auto;">
      </div>
      </div>
