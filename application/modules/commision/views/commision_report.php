        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Sales Code', dataField: 'Sales Code', width : 100 },
				  { text: 'Date', dataField: 'Date', width : 150 },
				  { text: 'Phase', dataField: 'Phase', width : 250 },
                  { text: 'Payment', dataField: 'Payment', width : 250 },
                  { text: 'Source', dataField: 'Source', width : 250 },
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Sales Commision Report </h4>
	   </div>
	</center>
    ...
    <div id='jqxWidget'>
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
<th> No </th> <th> Code </th> <th> Sales Code </th> <th> Date </th> <th> Phase </th> <th> Payment </th> <th> Source </th>
<th> Amount </th> <th> Confirmation </th>
           </tr>
           </thead>
		  ...
		  <?php 
              ...
              function payment($id){
                  $val = new Payment_lib();
                  return $val->get_name($id);
              }
              
              function bank($id){
                  $val = new Bank_lib();
                  return $val->get_details($id, 'acc_name').' - '.$val->get_details($id, 'acc_no');
              }
              
             function sales($id){
                  $val = new Sales_lib();
                  $sales = $val->get_detail_sales($id);  
                  return $sales->code;
              }
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
                       ...
                       <td class=\"strongs\">".sales($res->sales_id)."</td> 
                       <td class=\"strongs\">".tglin($res->dates)."</td> 
                       <td class=\"strongs\">".$res->phase."</td>
                       <td class=\"strongs\">".payment($res->payment_id)."</td>
                       <td class=\"strongs\">".bank($res->bank_id)."</td>
        ...
        <a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('commision/get_last/'.$sid); ?>"> 
