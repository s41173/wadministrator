...
<form id="ajaxform1" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo site_url("sales_payment/add_process"); ?>" enctype="multipart/form-data">
