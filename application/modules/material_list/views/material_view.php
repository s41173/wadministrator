...
<script src="<?php echo base_url(); ?>js/moduljs/materiallist.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('material_list/add_process/');?>";
	var sites_edit = "<?php echo site_url('material_list/update_process/');?>";
	var sites_del  = "<?php echo site_url('material_list/delete/');?>";
	var sites_get  = "<?php echo site_url('material_list/update/');?>";
    var sites_primary  = "<?php echo site_url('material_list/publish/');?>";
