...
<script src="<?php echo base_url(); ?>js/moduljs/language.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('language/add_process/');?>";
	var sites_edit = "<?php echo site_url('language/update_process/');?>";
	var sites_del  = "<?php echo site_url('language/delete/');?>";
	var sites_get  = "<?php echo site_url('language/update/');?>";
    var sites_primary  = "<?php echo site_url('language/primary/');?>";
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>
      ...
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('language_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
