...
<script type="text/javascript">
    ...
    var sites_details  = "<?php echo site_url('agent/details/');?>";
    var sites_primary = "<?php echo site_url('agent/publish/');?>";
...
<!-- links -->
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('agent_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Attribute -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		 <?php $this->load->view('agent_details'); ?> 
      </div>
      <!-- Modal Attribute -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('agent_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
