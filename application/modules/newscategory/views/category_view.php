...
<script src="<?php echo base_url(); ?>js/moduljs/newscategory.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('newscategory/add_process/');?>";
	var sites_edit = "<?php echo site_url('newscategory/update_process/');?>";
	var sites_del  = "<?php echo site_url('newscategory/delete/');?>";
	var sites_get  = "<?php echo site_url('newscategory/update/');?>";
