...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Add New Series-Model </h4>
</div>
...
<form id="upload_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action; ?>" 
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tname" class="form-control col-md-7 col-xs-12" type="text" name="tname" required placeholder="Model Name">
      </div>
    </div>
...
<input id="theight" class="form-control col-md-7 col-xs-12" type="number" name="theight" required placeholder="Height">
      </div>
    </div>
