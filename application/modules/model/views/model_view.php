...
<script src="<?php echo base_url(); ?>js/moduljs/model.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('model/add_process/');?>";
	var sites_edit = "<?php echo site_url('model/update_process/');?>";
	var sites_del  = "<?php echo site_url('model/delete/');?>";
	var sites_get  = "<?php echo site_url('model/update/');?>";
    var sites_primary  = "<?php echo site_url('model/publish/');?>";
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('model_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('model_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
