...
<form id="upload_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action; ?>" 
    ...
    <div class="form-group">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="tno" class="form-control col-md-7 col-xs-12" type="text" name="tno" required placeholder="">
      </div>
    </div>


  <div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12"> Account Bank </label>
    <div class="col-md-9 col-sm-9 col-xs-12">
     <textarea name="tbank" id="tbank" class="form-control" rows="3" placeholder="Bank Description"></textarea>
    </div>
  </div>
