...
<script src="<?php echo base_url(); ?>js/moduljs/bank.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('bank/add_process/');?>";
	var sites_edit = "<?php echo site_url('bank/update_process/');?>";
	var sites_del  = "<?php echo site_url('bank/delete/');?>";
	var sites_get  = "<?php echo site_url('bank/update/');?>";
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>
      ...
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('bank_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
