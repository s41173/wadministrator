...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Material Report </h4>
</div>
...
action="<?php echo $form_action_report; ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-sm-6 col-xs-12">
        <?php $js = "class='select2_single form-control' id='' tabindex='-1' style='width:150px;' "; 
    ...
    <div class="form-group">
      ...
      <div class="col-md-9 col-sm-6 col-xs-12">
           <select name="ctype" class="form-control" id="ctype" style="width:120px;">
