...
<script src="<?php echo base_url(); ?>js/moduljs/orders.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('orders/add_process/');?>";
	var sites_edit = "<?php echo site_url('orders/update_process/');?>";
	var sites_del  = "<?php echo site_url('orders/delete/');?>";
	var sites_get  = "<?php echo site_url('orders/invoice/');?>";
    var sites_primary  = "<?php echo site_url('orders/publish/');?>";
          ...
          <div class="row"> 
           ...
           <form id="searchform" class="form-inline">
              ...
              <div class="form-group">
                <?php $js = "class='select2_single form-control' id='cagent' tabindex='-1' style='min-width:150px;' "; 
