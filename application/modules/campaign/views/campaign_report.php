        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Email-From', dataField: 'Email-From', width : 150 },
				  { text: 'To', dataField: 'To', width : 250 },
  				  { text: 'Date', dataField: 'Date', width : 150 },
				  { text: 'Type', dataField: 'Type', width : 100 },
                  { text: 'Subject', dataField: 'Subject', width : 200 },
                  { text: 'Category', dataField: 'Category', width : 180 },
                  { text: 'Article', dataField: 'Article' },
                  { text: 'Status', dataField: 'Status', width : 80 }
                ]
            });
			
			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['1000', '2000', '3000', '5000']}); 
			
			$("#bexport").click(function() {
				
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Campaign-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Campaign-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Campaign-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Campaign-Summary'); }
			});
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Campaign Report </h4>
	   </div>
	</center>
    ...
    <div id='jqxWidget'>
		...
		<table id="table" border="0" width="100%">
            ...
            <thead>
           <tr>
<th> No </th> <th> Email-From </th> <th> To </th> <th> Date </th> <th> Type </th> <th> Subject </th> <th> Category </th> <th> Article </th> 
<th> Status </th> 
           </tr>
           </thead>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
                       ...
                       <td class=\"strongs\">".$res->email_from."</td> 
                       <td class=\"strongs\">".$res->email_to."</td> 
                       ...
                       <td class=\"strongs\">".get_article($res->article_id)."</td> 
        ...
        <a style="float:left; margin:10px;" title="Back" href="<?php echo site_url('campaign'); ?>"> 
