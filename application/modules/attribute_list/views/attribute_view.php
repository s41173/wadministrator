...
<script src="<?php echo base_url(); ?>js/moduljs/attribute_list.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('attribute_list/add_process/');?>";
	var sites_edit = "<?php echo site_url('attribute_list/update_process/');?>";
	var sites_del  = "<?php echo site_url('attribute_list/delete/');?>";
	var sites_get  = "<?php echo site_url('attribute_list/update/');?>";
    var sites_primary  = "<?php echo site_url('attribute_list/primary/');?>";
