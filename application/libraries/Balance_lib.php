...
class Balance_lib extends Custom_Model {
    ...
    protected $field = array('id', 'customer', 'beginning', 'end', 'vamount', 'month', 'year', 'created', 'updated', 'deleted');
    ...
    function fill($cust,$month,$year,$begin=0,$end=0)
    {
       ...
       if ($num == 0)
       {
          $trans = array('customer' => $cust, 'month' => $month, 'year' => $year, 'beginning' => $begin, 'end' => $end);
