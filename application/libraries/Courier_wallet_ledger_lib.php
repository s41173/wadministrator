...
class Courier_wallet_ledger_lib {
    ...
    private $ci;
    private $table = 'wallet_courier_ledger';
    protected $field = array('id', 'courier', 'code', 'no', 'dates', 'debit', 'credit', 'vamount', 'created', 'updated', 'deleted');
